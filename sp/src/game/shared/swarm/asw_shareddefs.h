...
// HOUNDEYE = grubs
#define ASW_COLLISION_GROUP_EGG COLLISION_GROUP_NPC		// asw (alien eggs)	
#define ASW_COLLISION_GROUP_BLOCK_DRONES COLLISION_GROUP_NPC		// asw
#define ASW_COLLISION_GROUP_BIG_ALIEN COLLISION_GROUP_NPC			// asw (shieldbug, queen)
#define ASW_COLLISION_GROUP_BUZZER COLLISION_GROUP_NPC
#define ASW_COLLISION_GROUP_BODY_SNATCHER COLLISION_GROUP_NPC				// asw (shieldbug, queen)
#else
enum
{
